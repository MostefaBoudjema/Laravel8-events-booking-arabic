        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {{ Form::label('title', __('quickadmin.events.fields.title'), ['class' => 'control-label']) }}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('description', __('quickadmin.events.fields.description'), ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('start_time', __('quickadmin.events.fields.start-time'), ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('venue', __('quickadmin.events.fields.venue'), ['class' => 'control-label']) !!}
